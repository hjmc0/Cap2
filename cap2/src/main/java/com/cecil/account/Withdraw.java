        ...
        try {
            ...
            if (temp == acctID) {
                if (! CheckActive.isActive(acctID)){
                    System.out.println("Account inactive, cannot withdraw!");
                    return;
                }
                while (sure != 1) {
                    ...
                    while (sure != 1 && sure != 2) {
                        System.out.println("-----------------------------------------------------------");
                        System.out.println(
                                "Continue to " + bold + red + "WITHDRAW $" + String.format("%.2f", tempBal) + reset
                                        + " from ACCOUNT No.: " + acctID + " ?");
                ...
                System.out.println(
                        "WITHDRAW AMOUNT           :" + red + " - $ " + String.format("%.2f", tempBal) + reset);
